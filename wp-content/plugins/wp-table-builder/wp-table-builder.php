...
/*
 * Self-update via GitHub Releases (plugin-update-checker v5).
 * Release flow: bump Version + WTB_VERSION here, tag (e.g. v1.2.0),
 * then attach the built zip to a GitHub Release for that tag.
 */
require_once WTB_PLUGIN_DIR . 'vendor/plugin-update-checker/plugin-update-checker.php';

use YahnisElsts\PluginUpdateChecker\v5\PucFactory;

$wtb_update_checker = PucFactory::buildUpdateChecker(
    'https://github.com/adityjk/wp-table-builder',
    __FILE__,
    'wp-table-builder'
);
$wtb_update_checker->getVcsApi()->enableReleaseAssets( '/\.zip($|[?&#])/i' );
